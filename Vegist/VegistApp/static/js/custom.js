...
/* ========================================== 
  ...
  let price1 = document.getElementById('100gprice').innerHTML;
  let price2 = document.getElementById('250gprice').innerHTML;
  let price3 = document.getElementById('500gprice').innerHTML;
  let price4 = document.getElementById('1kgprice').innerHTML;
  let hun_btn = document.getElementById('100g');
  let qua_btn = document.getElementById('250g');
  let half_btn = document.getElementById('500g');
  let one_btn = document.getElementById('1kg');
  let quantityField = document.getElementById('quantity');
  let originl_price = document.getElementById("old-price");
  let old_price1 = document.getElementById("price1").value;
  let old_price2 = document.getElementById("price2").value;
  let old_price3 = document.getElementById("price3").value;
  let old_price4 = document.getElementById("price4").value;
  let currentprice = Number(price1);
  let hun_price = currentprice;
  let qua_price = Number(price2);
  let half_price = Number(price3);
  let one_price = Number(price4);

  originl_price.innerHTML = Number(old_price1).toFixed(2);

  // Initial Price Setup (100g)
  let selectedSize = '100';
  let addToCartButton = document.getElementById('Cartbtn');
  addToCartButton.setAttribute('data-size', selectedSize);
  addToCartButton.setAttribute('data-price', currentprice);
  ...
  hun_btn.addEventListener('click', function () {
      quantityField.value = 1;
      selectedSize = '100';
      currentprice = hun_price.toFixed(2);
      originl_price.textContent = Number(old_price1).toFixed(2);

      document.getElementById('100gprice').style.display = 'block';
      document.getElementById('250gprice').style.display = 'none';
      document.getElementById('500gprice').style.display = 'none';
      document.getElementById('1kgprice').style.display = 'none';


      hun_btn.classList.add("active");
      qua_btn.classList.remove("active");
      half_btn.classList.remove("active");
      one_btn.classList.remove("active");

      // Update "Add to Cart" button with selected size and price
      addToCartButton.setAttribute('data-size', selectedSize);
      addToCartButton.setAttribute('data-price', currentprice);

      // Debugging: log the current data-size and data-price
      console.log('Size:', addToCartButton.getAttribute('data-size'));
      console.log('Price:', addToCartButton.getAttribute('data-price'));
  });

  qua_btn.addEventListener('click', function () {
      quantityField.value = 1;
      selectedSize = '250';
      currentprice = qua_price;
      document.getElementById('250gprice').innerHTML = currentprice.toFixed(2);
      originl_price.textContent = Number(old_price2).toFixed(2);
      

      document.getElementById('100gprice').style.display = 'none';
      document.getElementById('250gprice').style.display = 'block';
      document.getElementById('500gprice').style.display = 'none';
      document.getElementById('1kgprice').style.display = 'none';


      hun_btn.classList.remove("active");
      qua_btn.classList.add("active");
      half_btn.classList.remove("active");
      one_btn.classList.remove("active");
  ...
  half_btn.addEventListener('click', function () {
      ...
      document.getElementById('500gprice').innerHTML = currentprice.toFixed(2);
      originl_price.textContent = Number(old_price3).toFixed(2);
      

      document.getElementById('100gprice').style.display = 'none';
      document.getElementById('250gprice').style.display = 'none';
      document.getElementById('500gprice').style.display = 'block';
      document.getElementById('1kgprice').style.display = 'none';


      hun_btn.classList.remove("active");
      qua_btn.classList.remove("active");
      half_btn.classList.add("active");
      one_btn.classList.remove("active");
  ...
  one_btn.addEventListener('click', function () {
      quantityField.value = 1;
      selectedSize = '1000';
      currentprice = one_price;
      document.getElementById('1kgprice').innerHTML = currentprice.toFixed(2);
      originl_price.textContent = Number(old_price4).toFixed(2);
      

      document.getElementById('100gprice').style.display = 'none';
      document.getElementById('250gprice').style.display = 'none';
      document.getElementById('500gprice').style.display = 'none';
      document.getElementById('1kgprice').style.display = 'block';
  ...
  document.getElementById("incrementbtn").addEventListener("click", function () {
      ...
      let currentquantity = quantityField.value;
      addToCartButton.setAttribute('data-quantity', currentquantity);
      console.log('Quantity:', addToCartButton.getAttribute('data-quantity'));
  });
  ...
  let price1 = document.getElementById('comboprice').innerHTML;
  let quantityField = document.getElementById('quantity');
  let originl_price = document.getElementById("old-price");
  let old_price1 = document.getElementById("price1").value;
  let currentprice = Number(price1);
  ...
  let boxsize = document.getElementById('size').innerHTML;

// Remove the "G" character and convert to a number
  //let numericBoxSize = parseInt(boxsize.replace('G', ''));

  let selectedSize = boxsize.replace('G', '');
  let addToCartButton = document.getElementById('Cartbtn');
  addToCartButton.setAttribute('data-size', selectedSize);
  addToCartButton.setAttribute('data-price', currentprice);
...
$("#review-form").submit(function(e){
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $('.reviewdata').load(location.href + " .reviewdata");
